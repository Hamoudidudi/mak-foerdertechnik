...
/* =========================================================================
   /leistungen/beratung-planung – clean Ocean, subtil belebt
   ========================================================================= */
...
export default function BeratungPlanungPage() {
    ...
    const jsonLd = useMemo(
        () => ({
            ...
            '@type': 'Service',
            name: 'Beratung & Planung – MAK Fördertechnik',
            description:
                'Bestandsanalyse, Variantenvergleich (LCC), Ausschreibung/Leistungsverzeichnis, BIM/CAD und Projektbegleitung – herstellerunabhängig, normkonform, wirtschaftlich.',
            ...
            offers: {
                ...
                priceCurrency: 'EUR',
                description: 'Analyse, Ausschreibung und Projektbegleitung – modular & transparent.',
            },
        }),
        []
    );
    ...
    return (
        <>
            ...
            <main data-theme="ocean" className="min-h-screen bg-neutral-50 text-neutral-900">
                ...
                >
                    {/* sehr dezente Ocean-Lichtflächen */}
                    <div
                        aria-hidden
                    ...
                    />
                    {/* super subtiler dotted-Footer */}
                    <div className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-20 dotted opacity-15" />
                        ...
                        <div className="grid items-center gap-10 md:grid-cols-12">
                            <div className="md:col-span-7">
                                ...
                                <p className="mt-4 max-w-prose text-lg text-neutral-700">
                                    Von der Bestandsaufnahme bis zur Übergabe: Wir planen herstellerunabhängig, wirtschaftlich und
                                    normkonform – transparent dokumentiert und klar kommuniziert.
                                </p>
                                ...
                                {/* dezente Besonderheit: Prozess in 4 Phasen */}
                                <ol className="mt-8 grid gap-3 text-sm sm:grid-cols-4">
                                    {[
                                        { t: 'Analyse', d: 'Ist-Zustand & Ziele' },
                                        { t: 'Konzept', d: 'Varianten & LCC' },
                                        { t: 'Ausschreibung', d: 'LV & Vergabe' },
                                        { t: 'Umsetzung', d: 'Begleitung & Übergabe' },
                                    ].map((s, i) => (
                                        <li key={s.t} className="rounded-xl border border-[var(--tint-border)] bg-[var(--tint-bg)] p-3">
                                            <div className="flex items-center justify-between">
                                                <span className="text-[var(--tint-text)] font-semibold">{s.t}</span>
                                ...
                                >
                                    <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <p className="text-sm font-medium">Unverbindliches Erstgespräch</p>
                                        </div>
                                        <p className="mt-3 text-neutral-700">
                                            Wir klären Ziele, Rahmen & Budget und empfehlen den passenden Weg – inkl. Zeitschiene & Nächste Schritte.
                                        </p>
                                        <div className="mt-4">
                                            <CTA href="/kontakt" variant="primary">
                ...
                <section id="leistungen" className="bg-neutral-50 py-14 md:py-20">
                    <Container>
                        <SectionHeader
                            eyebrow="Leistungen"
                            title="Strukturiert planen – transparent umsetzen"
                            intro="Herstellerunabhängige Beratung, klare Unterlagen und wirtschaftliche Entscheidungen."
                        />
                            ...
                            {[
                                {
                                    ...
                                    text: 'Technischer Zustand, Schwachstellen, Norm-Themen strukturiert erfassen.',
                                },
                                {
                                    icon: BarChart3,
                                    title: 'Variantenvergleich (LCC)',
                                    text: 'Kosten/Nutzen über Lebenszyklus, realistische Einsparungen & Amortisation.',
                                },
                                {
                                    icon: ClipboardList,
                                    title: 'Ausschreibung & LV',
                                    text: 'Leistungsverzeichnis, Bieterfragen, Vergabeempfehlung – transparent.',
                                },
                                {
                                    icon: Map,
                                    title: 'BIM/CAD & Pläne',
                                    text: 'Schnittstellen, Maße, Kabine/Türen – prüfbare Planungsgrundlagen.',
                                },
                                {
                                    icon: Shield,
                                    title: 'Normen & Genehmigung',
                                    text: 'EN/UVV, Brandschutz-Schnittstellen, Abnahme-Ready.',
                                },
                                {
                                    icon: Cpu,
                                    title: 'Projektsteuerung',
                                    text: 'Terminierung, Meilensteine, Abnahme & Dokumentation.',
                                },
                ...
                <section id="pakete" className="border-t bg-white py-14 md:py-20">
                    <Container>
                        <SectionHeader
                            eyebrow="Pakete"
                            title="Der passende Beratungsumfang"
                            intro="Sie wählen die Tiefe – wir liefern die Unterlagen und begleiten auf Wunsch bis zur Übergabe."
                        />
                        <div className="mt-10 grid gap-6 md:grid-cols-3">
                            {[
                                {
                                    name: 'Analyse',
                                    points: ['Vor-Ort-Begehung', 'Kurzbericht & Prioritäten', 'Empfehlung nächster Schritte'],
                                },
                                {
                                    name: 'Ausschreibung',
                                    points: ['Leistungsverzeichnis', 'Bieterfragen & Vergabe', 'Dokumentation'],
                                },
                                {
                                    name: 'Projektbegleitung',
                                    points: ['Terminplan & Steuerung', 'Abnahme-Ready', 'Übergabe & Review'],
                                },
                            ].map((p, idx) => (
                                <div
                                    key={p.name}
                ...
                <section id="mehrwert" className="border-t bg-neutral-50 py-14 md:py-20">
                    <Container>
                        <SectionHeader
                            eyebrow="Mehrwert"
                            title="Wirtschaftlich, nachvollziehbar, abnahmefähig"
                            intro="Transparente Unterlagen, klare Entscheidungen, ruhige Umsetzung – mit sauberer Dokumentation."
                        />
                        <div className="mt-8 grid gap-6 md:grid-cols-3">
                            {[
                                { icon: BarChart3, title: 'Wirtschaftlichkeit', text: 'Realistische LCC, klare Effekte & Prioritäten.' },
                                { icon: Sparkles, title: 'Transparenz', text: 'Vergleichbare Angebote & nachvollziehbare Vergabe.' },
                                { icon: Shield, title: 'Sicherheit & Normen', text: 'Abnahme-Ready – weniger Risiko im Projekt.' },
                            ].map(({ icon: Icon, title, text }) => (
                                <div
                                    key={title}
                ...
                <section id="faq" className="border-t bg-white py-14 md:py-20">
                    <Container>
                        <SectionHeader eyebrow="FAQ" title="Häufige Fragen zu Beratung & Planung" />
                ...
                <section id="kontakt" className="border-t bg-neutral-50 py-14 md:py-20">
                    <Container>
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            >
                                Beratung / Ausschreibung anfragen
                            </h2>
                            <p className="mx-auto mt-3 max-w-prose text-neutral-700">
                                Wir prüfen Ziele & Rahmen, empfehlen den passenden Umfang und erstellen ein klares Angebot.
                            </p>
...
/* FAQ */
const FAQ_ITEMS = [
    { q: 'Arbeiten Sie herstellerunabhängig?', a: 'Ja. Wir planen neutral und vergleichen Lösungen objektiv.' },
    { q: 'Erstellen Sie Leistungsverzeichnisse?', a: 'Ja, inklusive Bieterfragen, Wertung und Vergabeempfehlung.' },
    { q: 'Gehören BIM/CAD-Unterlagen dazu?', a: 'Auf Wunsch liefern wir prüfbare Pläne und BIM/CAD-Grundlagen.' },
    { q: 'Begleiten Sie die Umsetzung?', a: 'Ja, von Terminplan bis Abnahme und Dokumentation.' },
    { q: 'Wie stelle ich Wirtschaftlichkeit sicher?', a: 'Mit LCC-Variantenvergleich, messbaren Zielen und Priorisierung.' },
];
